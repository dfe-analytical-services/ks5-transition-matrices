...
-- REMEBER to remove the VTQ filter on line 254 for 2024A
...
select * into #subj_tab from QRD.dbo.Subje01_2024_09_25
If object_Id('tempDB..#tab2') is not null drop table #tab2
select * into #tab2 from QRD.dbo.Table2_2024_09_25
If object_Id('tempDB..#tab3') is not null drop table #tab3
select * into #tab3 from QRD.dbo.Table3_2024_09_25
If object_Id('tempDB..#tab4') is not null drop table #tab4
select * into #tab4 from QRD.dbo.Table4_2024_09_25
If object_Id('tempDB..#subj') is not null drop table #subj


If object_Id('tempDB..#raw_inst') is not null drop table #raw_inst
select * into #raw_inst from KS5_RESTRICTED.[Outputs].[RAW_Inst_POST16_20241014_201235_TLEVEL_DISD]
If object_Id('tempDB..#raw_LA') is not null drop table #raw_LA
select * into #raw_LA from KS5_RESTRICTED.[Outputs].[RAW_LEA_POST16_20241014_201236_TLEVEL_DISD]
If object_Id('tempDB..#exam') is not null drop table #exam
select * into #exam from [KS5_RESTRICTED].[Outputs].[Exam_PT_POST16_20241014_190117_TLEVEL_DISD]
...
select * into #indicator from KS5_RESTRICTED.[Outputs].[PupilIndicators_POST16_20241014_195753_TLEVEL_DISD]
If object_Id('tempDB..#PRIOR') is not null drop table #PRIOR
select * into #PRIOR from KS5_STATISTICS_RESTRICTED.[EES_2024U].[PRIORS_KS4end2023]
If object_Id('tempDB..#Allocations') is not null drop table #Allocations
select PUPILID, END_KS into #Allocations from KS5_RESTRICTED.[Outputs].[PupilAllocations_POST16_20241014_163831_TLEVEL_DISD]
...
select * 
into [KS5_STATISTICS_RESTRICTED].[TM_2024].[TM_data_2024U]
from #TM_data
