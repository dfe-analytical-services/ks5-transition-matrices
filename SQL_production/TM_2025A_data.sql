...
select * into #subj_tab from QRD.dbo.Subje01_2025_11
If object_Id('tempDB..#tab2') is not null drop table #tab2
select * into #tab2 from QRD.dbo.Table2_2025_11
If object_Id('tempDB..#tab3') is not null drop table #tab3
select * into #tab3 from QRD.dbo.Table3_2025_11
If object_Id('tempDB..#tab4') is not null drop table #tab4
select * into #tab4 from QRD.dbo.Table4_2025_11
If object_Id('tempDB..#subj') is not null drop table #subj


If object_Id('tempDB..#raw_inst') is not null drop table #raw_inst
select * into #raw_inst from KS5_RESTRICTED.[Outputs].[RAW_Inst_POST16_202425A]
If object_Id('tempDB..#raw_LA') is not null drop table #raw_LA
select * into #raw_LA from KS5_RESTRICTED.[Outputs].[RAW_LEA_POST16_202425A]
If object_Id('tempDB..#exam') is not null drop table #exam
select * into #exam from [KS5_RESTRICTED].[Outputs].[Exam_PT_POST16_202425A]
...
select * into #indicator from KS5_RESTRICTED.[Outputs].[PupilIndicators_POST16_202425A]
...
select PUPILID, END_KS into #Allocations from KS5_RESTRICTED.[Outputs].[PupilAllocations_POST16_202425A]
...
--drop table [KS5_STATISTICS_RESTRICTED].[TM_2025].[TM_data_2025A]

select * 
into [KS5_STATISTICS_RESTRICTED].[TM_2025].[TM_data_2025A]
from #TM_data
