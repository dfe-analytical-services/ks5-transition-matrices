...
select * into #subj_tab from QRD.dbo.Subje01_2022_09_09
If object_Id('tempDB..#tab2') is not null drop table #tab2
select * into #tab2 from QRD.dbo.Table2_2022_09_09
If object_Id('tempDB..#tab3') is not null drop table #tab3
select * into #tab3 from QRD.dbo.Table3_2022_09_09
If object_Id('tempDB..#tab4') is not null drop table #tab4
select * into #tab4 from QRD.dbo.Table4_2022_09_09
...
select * into #raw_inst from KS5_RESTRICTED.[Outputs].[RAW_Inst_POST16_2022U]
If object_Id('tempDB..#raw_LA') is not null drop table #raw_LA
select * into #raw_LA from KS5_RESTRICTED.[Outputs].[RAW_LEA_POST16_2022U]
If object_Id('tempDB..#exam') is not null drop table #exam
select * into #exam from [KS5_RESTRICTED].[Outputs].[Exam_PT_POST16_2022U]
...
select * into #indicator from KS5_RESTRICTED.[Outputs].[PupilIndicators_POST16_2022U]
If object_Id('tempDB..#PRIOR') is not null drop table #PRIOR
select * into #PRIOR from [KS5_STATISTICS_RESTRICTED].[EES_2022].[PRIORS_KS4end2021]
If object_Id('tempDB..#Allocations') is not null drop table #Allocations
select PUPILID, END_KS into #Allocations from KS5_RESTRICTED.[Outputs].[PupilAllocations_POST16_2022U]
...
--drop table [KS5_STATISTICS_RESTRICTED].[TM_2022].[TM_data_2022U]

select * 
into [KS5_STATISTICS_RESTRICTED].[TM_2022].[TM_data_2022U]
from #TM_data
