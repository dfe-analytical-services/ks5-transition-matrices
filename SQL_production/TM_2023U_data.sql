...
select * into #raw_inst from KS5_RESTRICTED.[Outputs].[RAW_Inst_POST16_202223U]
If object_Id('tempDB..#raw_LA') is not null drop table #raw_LA
select * into #raw_LA from KS5_RESTRICTED.[Outputs].[RAW_LEA_POST16_202223U]
If object_Id('tempDB..#exam') is not null drop table #exam
select * into #exam from [KS5_RESTRICTED].[Outputs].[Exam_PT_POST16_202223U]
...
select * into #indicator from KS5_RESTRICTED.[Outputs].[PupilIndicators_POST16_202223U]
If object_Id('tempDB..#PRIOR') is not null drop table #PRIOR
select * into #PRIOR from KS5_STATISTICS_RESTRICTED.[EES_2023U].[PRIORS_KS4end2022]
If object_Id('tempDB..#Allocations') is not null drop table #Allocations
select PUPILID, END_KS into #Allocations from KS5_RESTRICTED.[Outputs].[PupilAllocations_POST16_202223U]
...
select * 
into [KS5_STATISTICS_RESTRICTED].[TM_2023].[TM_data_2023U]
from #TM_data
